...
<img width="600" height="500" alt="image" src="https://github.com/user-attachments/assets/afeeaa14-a53d-4631-9596-dde18c08cd74" />
...
<img width="600" height="500" alt="image" src="https://github.com/user-attachments/assets/6421d701-039c-4fc0-9799-3cc6691282e3" />
...
<img width="564" height="200" alt="image" src="https://github.com/user-attachments/assets/ad97bb5c-9773-4dc8-9a23-fad1acfb57a8" />

Congratulations! You have succesfully installed a pack! Reboot your game for the changes to take effect
<img width="692" height="169" alt="image" src="https://github.com/user-attachments/assets/b80b66f9-7ba4-476e-9bb5-46c2701deb64" />
...
> NOTE! All capeNames key must match a valid cape name (see bellow) & all cape textures must match the standard ``64x32px`` cape format (you can use this [cape](https://minecraft.wiki/images/MINECON_2012_Cape_%28texture%29.png?e8ca7&format=original) as a base)
...
### Bundling up
After you have finished creating your beautiful pack you can take ur favorite zip compressor and compress all the files (NOT the root folder itself) into a ``.zip`` archive :P
If you want to also be more clean u could rename your ``.zip`` to ``.cp`` (cape-pack)


**Here is the list of all valid capes**
...
[
  ...
  { "name": "founders", "path": "99/99aba02ef05ec6aa4d42db8ee43796d6cd50e4b2954ab29f0caeb85f96bf52a1" },
  { "name": "copper", "path": "5e/5e6f3193e74cd16cdd6637d9bae5484e3a37ff2a14c2d157c659a07810b1bdca" },
  { "name": "followers", "path": "56/569b7f2a1d00d26f30efe3f9ab9ac817b1e6d35f4f3cfb0324ef2d328223d350" },
  ...
  { "name": "mcc", "path": "56/56c35628fe1c4d59dd52561a3d03bfa4e1a76d397c8b9c476c2f77cb6aebb1df" },
